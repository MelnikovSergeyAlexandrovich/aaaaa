...
{
    public partial class Diagram_Temp : Page
    {
        ...
        public Diagram_Temp()
        {
            ...
            PressurePlotView.Plot.YLabel("Температура");
        ...
        private async void Forecast()
        {
            ...
            List<double> tempur = new List<double>();
            ...
            foreach (WeatherForecastItem item in forecast.List)
            {
                ...
                if (forecastDateTime >= currentDateTime && forecastDateTime <= currentDateTime.AddHours(24))
                {
                    ...
                    tempur.Add(Math.Round(temp, 0));
                    datetimes.Add(forecastDateTime);
                }
            }

            PlotPressureForecast(datetimes.ToArray(), tempur.ToArray());
        }
        ...
        private void PlotPressureForecast(DateTime[] datetimes, double[] tempu)
        {
            ...
            var scatterPlot = PressurePlotView.Plot.AddScatter(x, tempu);
